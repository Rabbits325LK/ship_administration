	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">根据Id查看船艇类型</div>
				...
				<div class="panel-body">
					<dl>
						<dt>必带参:</dt>
						<dd class="well"><%=basePath%>APIship/QueryShipType.do?shipTypeCode=船艇类型编号
						</dd>
						...
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
							{"shipType":{"shipTypeCode":1,"shipTypeName":"游艇"},"result":"success"}
						</dd>
						<br />
						<dt>参数:</dt>
