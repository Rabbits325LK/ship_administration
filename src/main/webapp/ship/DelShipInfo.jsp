	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">根据游艇编号删除游艇信息
				</div>
				...
				<div class="panel-body">
					<dl>
						...
						<dt>带参:</dt>
						<dd class="well"><%=basePath%>APIship/DelShipInfo.do?shipId=游艇编号
						</dd>
						<br />
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>String</td>
								<td></td>
								<td>"success":成功<br/>"shipInfo:null":游艇信息不存在</td>
							</tr>
						</table>
