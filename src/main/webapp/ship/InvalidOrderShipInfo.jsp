	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">预订受理作废 <br>
				</div>
				...
				<div class="panel-body">
					<dl>
						...
						<dt>带参:</dt>
						<dd class="well"><%=basePath %>APIship/InvalidOrderShipInfo.do?shipOperationCode=预订订单编号
						</dd>
						<br />
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
