	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">根据编号修改船艇信息</div>
				...
				<div class="panel-body">
					<dl>
						<dt>必带参:</dt>
						<dd class="well"><%=basePath%>APIship/UpdateShipInfo.do?shipId=船艇编号
						</dd>

						<dt>带参:</dt>
						<dd class="well"><%=basePath%>APIship/UpdateShipInfo.do?shipId=船艇编号&shipName=船艇名称&shipTypeCode=类型编号&shipSize=尺寸&shipCapacity=载量&shipImages=图片路径
						</dd>
						<br />
						<dt>返回JSON格式数据:</dt>
