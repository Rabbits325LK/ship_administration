	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">根据Id查看游艇相信信息</div>
				...
				<div class="panel-body">
					<dl>
						<dt>必带参:</dt>
						<dd class="well"><%=basePath%>APIship/QueryShipInfo.do?shipId=船艇编号
						</dd>
						...
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
							{"ship":{"shipId":1,"shipName":"荣超地产","shipType":"游艇","shipSize":"60","shipCapacity":"14","shipImages":null}}
						</dd>
						<br />
						<dt>参数:</dt>
