	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">根据游艇编号删除游艇类型
				</div>
				...
				<div class="panel-body">
					<dl>
						...
						<dt>带参:</dt>
						<dd class="well"><%=basePath%>APIship/DeleteShipType.do?shipId=船艇类型编号
						</dd>
						<br />
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>String</td>
								<td></td>
								<td>"success":成功<br/>"no data":数据不存在</td>
							</tr>
						</table>
