			...
			<div
				...
				<div class="panel-body">
					<dl>
						...
						<dt>带参:</dt>
						<dd class="well"><%=basePath%>APIuser/QueryUserInfoPage.do?numPage=想查看的页数&roleId=角色编号
						</dd>
						<br />
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
							{"pageCount":1,"totalCount":2,"pageCurrent":1,"userInfos":[{"userId":1,"roleId":1,"userName":"rabbits325","userPwd":"lk5115702","nickName":"梁慷","gender":1,"userIdcard":null,"address":"天心区","email":"rabbits325@live.cn","tel":"07315115702","phone":"18676660220","qq":"464020173","userImages":null},{"userId":2,"roleId":2,"userName":"testuser","userPwd":"lk5115702","nickName":"测试帐号","gender":1,"userIdcard":"430103199002253016","address":"湖南省天心区金盆岭通用时代国际社区12栋402房","email":"rabbits325@live.cn","tel":"073185115702","phone":"18676660220","qq":"464020173","userImages":null}]}
						</dd>
						<br />
						<dt>参数:</dt>
