	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">修改角色信息</div>
				<div class="page-header">
					<h3 class="panel-title">
				...
				<div class="panel-body">
					<dl>
						<dt>必带参:</dt>
						<dd class="well"><%=basePath%>APIuser/AddRoleInfo.do?roleId=角色编号
						</dd>

						<dt>带参:</dt>
						<dd class="well"><%=basePath%>APIuser/AddRoleInfo.do?roleId=角色编号&roleName=角色名称
						</dd>
						<br />
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>String</td>
								<td></td>
								<td>"no data":用户已存在<br>"success":成功</td>
							</tr>
						</table>
					</dl>
				</div>
