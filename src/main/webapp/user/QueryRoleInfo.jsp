	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row">
			...
			<div
				...
				<div class="panel-body">根据编号查询角色信息</div>
				<div class="page-header">
					<h3 class="panel-title">
				...
				<div class="panel-body">
					<dl>
						<dt>必带参:</dt>
						<dd class="well"><%=basePath%>APIuser/QueryRoleInfo.do?roleId=角色编号
						</dd>
						...
						<dt>返回JSON格式数据:</dt>
						<dd class="well">
							{"result":"success","roleInfo":{"roleId":1,"roleName":"root"}}
						</dd>
						<br />
						<dt>参数:</dt>
